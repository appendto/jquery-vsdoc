...
$.fn = $.prototype = {
	...
	animate: function(properties, duration, easing, complete){
		...
		/// 	A string indicating which easing function to use for the transition.
		/// </param>
		///	<param name="complete" type="Function" optional="true">
		/// 	A function to call once the animation is complete.
		/// </param>
		/// <returns type="jQuery" />
	}, 
	...
	prepend: function(content, content1){
		/// <summary>
		...
		/// </param>
		///	<param name="content1" type="jQuery" optional="true">
...
jQuery.subclass = function(){
		...
		/// 	&#10;&#10;API Reference: http://api.jquery.com/jQuery.subclass
		/// </summary>
		/// <returns type="Boolean" />
};
